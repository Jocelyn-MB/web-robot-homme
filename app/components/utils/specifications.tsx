...
export default function QuoteSection() {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 md:gap-lg py-lg quote__section__grid lg:h-full">
      ...
      <div className="flex flex-col justify-center col-span-full md:col-span-6 md:px-8 md:py-8 lg:py-0 md:items-center md:justify-center">
        <div className="max-w-lg">
          ...
          <p className="text-dark font-novoApply text-sm">García Mendoza Ángel, </p>
